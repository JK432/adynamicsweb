  ...
  <div class="container-xxl py-6 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <!-- <i class="bi bi-hearts display-1 text-primary"></i> -->
          <i class="bi bi-suit-heart-fill display-1 text-primary"></i>
          <!-- <i class="bi bi-exclamation-triangle display-1 text-primary"></i> -->
          <h1 class="display-1">Thank You!</h1>
          <h3 class="mb-4">We will get back to you shortly.</h3>
          <!-- <h1 class="mb-4"></h1> -->
          <p class="mb-4">Thank you for completing the form.</p>
