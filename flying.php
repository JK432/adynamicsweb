...
<script>
  ...
  gtag('config', 'AW-16756585547');
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-VZBX07CBJ0"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-VZBX07CBJ0');
    </script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PFNNX2Q3"
    ...
    <div class="demo-class">
        <iframe src="https://www.youtube.com/embed/lKr-EdxFhnM?si=rVfbLDS_tgJVAEvE" id="player"
    ...
    <div class="container-xxl mt-4 my-xl-6 py-6 pb-0">
        <div class="container" style="margin-top:-70px ;">
            <div class="text-center mx-auto " data-wow-delay="0.1s" style="max-width: 500px">
                <h1 class="display-6 ">
                    Our Global Network of Services
                </h1>
                <h6 class="text-secondary mb-2 map-sub-text" style="font-size: 16px; font-weight:500;">Tap on the
                    countries to explore our courses</h6>
            </div>
        </div>
    </div>
    ...
    <div class="map" id="map-container">
        ...
        <div class="country-content">
            <div class="usa-content">
                ...
                <a href="/flying/cpltexas.php">
                    <div class="item">
                        <h3 class="fs-6">
                            FAA CPL Training in Texas
                        </h3>
                        <p>
                            accelerate your path to becoming
                            a pilot with FAA CPL
                        ...
                        <div class="item-link">
                            <a class="mob-link" href="/flying/cpltexas.php">
                                <img src="/assets/img/plain-icon.png" alt="plain link">
                                USAA
                            </a>
                        </div>
            ...
            <div class="australia-content">
                <a href="/flying/cplaustralia.php">
                    <div class="item">
                        <h3>
                            CASA CPL TRAINING IN AUSTRALIA
                        </h3>
                        <p>
                            Demanding program intended to ready
                            individuals for a professional pilot career
                        ...
                        <div class="item-link">
                            <a class="mob-link" href="/flying/cplaustralia.php">
                                <img src="/assets/img/plain-icon.png" alt="plain link">
                                CASA CPL
                            </a>
                        </div>
        ...
        <svg id="world-map" style="fill: #b9b9b9;" xmlns:dc="http://purl.org/dc/elements/1.1/"
            ...
            xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" version="1.2" id="svg2" xml:space="preserve"
            inkscape:version="0.91 r13725" sodipodi:docname="World_map_-_low_resolution.svg"
            viewBox="1.17 0.3 948.28 622.7">
            ...
            <sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1" objecttolerance="10"
                ...
                inkscape:window-width="1920" inkscape:window-height="980" id="namedview342" showgrid="false"
                inkscape:object-nodes="true" inkscape:snap-smooth-nodes="true" inkscape:snap-nodes="true"
                inkscape:object-paths="true" inkscape:zoom="1" inkscape:cx="248.04005" inkscape:cy="326.05286"
            ...
            <path
                ...
                id="south_sudan" inkscape:label="#south sudan" />
            <path
            ...
            <!-- India marker-->
            <circle class="ripple ripple1" cx="670" cy="260" r="30"></circle>
            <circle class="ripple ripple2" cx="670" cy="260" r="15"></circle>
            <circle class="ripple ripple3" cx="670" cy="260" r="4"></circle>

            <!-- USA marker-->
            <circle class="ripple ripple1" cx="180" cy="200" r="30"></circle>
            <circle class="ripple ripple2" cx="180" cy="200" r="15"></circle>
            <circle class="ripple ripple3" cx="180" cy="200" r="4"></circle>

            <!-- South Africa marker-->
            <circle class="ripple ripple1" cx="520" cy="430" r="30"></circle>
            <circle class="ripple ripple2" cx="520" cy="430" r="15"></circle>
            <circle class="ripple ripple3" cx="520" cy="430" r="4"></circle>

            <!-- Morocco marker-->
            <circle class="ripple ripple1" cx="420" cy="260" r="30"></circle>
            <circle class="ripple ripple2" cx="420" cy="260" r="15"></circle>
            <circle class="ripple ripple3" cx="420" cy="260" r="4"></circle>

            <!-- Tunisia marker -->
            <circle class="ripple ripple1" cx="480" cy="235" r="30"></circle>
            <circle class="ripple ripple2" cx="480" cy="235" r="15"></circle>
            <circle class="ripple ripple3" cx="480" cy="235" r="4"></circle>

            <!-- Argentina marker -->
            <circle class="ripple ripple1" cx="280" cy="450" r="30"></circle>
            <circle class="ripple ripple2" cx="280" cy="450" r="15"></circle>
            <circle class="ripple ripple3" cx="280" cy="450" r="4"></circle>

            <!-- Australia marker -->
            <circle class="ripple ripple1" cx="810" cy="430" r="30"></circle>
            <circle class="ripple ripple2" cx="810" cy="430" r="15"></circle>
            <circle class="ripple ripple3" cx="810" cy="430" r="4"></circle>

            <!-- animating lines -->
            <path id="in-sa" class="line" d="M670,260 Q550,300 520,430"></path>
            <path id="in-ag" class="line" d="M670,260 Q350,300 280,450"></path>
            <path id="in-tun" class="line" d="M670,260 Q550,150 480,235"></path>
            <path id="in-aus" class="line" d="M670,260 Q800,300 810,430"></path>
            <path id="in-mor" class="line" d="M670,260 Q500,90 420,260"></path>
            <path id="in-usa" class="line" d="M670,260 Q500,50 180,200"></path>
            ...
            <div class="d-flex flex-column gap-2">
                    ...
                    <div class="courses-item d-flex flex-column flex-xl-row arc-shadow overflow-hidden h-100 bg-light rounded-pill shadow-lg">
                        <div class="text-center py-3 px-5 w-100 d-flex align-items-center justify-content-center flex-column">
                            ...
                            <!-- <ol class="breadcrumb justify-content-center mb-0">
                                ...
                                <li class="breadcrumb-item small">
                                    <i class="fa fa-calendar-alt text-primary me-2"></i>7 Months
                                </li>
                                <li>
                                    <i class="fa fa-map-marker text-primary me-2"></i>Click to learn more
                                </li>
                ...
                <div data-wow-delay="0.1s" class="position-relative d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="courses-item d-flex flex-column flex-xl-row arc-shadow overflow-hidden h-100 bg-light rounded-pill shadow-lg">
                        <div class="text-center py-3 px-5 w-100 d-flex align-items-center justify-content-center flex-column">
                            ...
                            <a href="./flying/cplcalifornia.php" class="btn btn-outline-primary btn-sm rounded-pill px-3 py-2 fs-10px">
                                Read more
                            </a>
                            <!-- <ol class="breadcrumb justify-content-center mb-0">
                                <li class="breadcrumb-item small">
                ...
                <div data-wow-delay="0.1s" class="position-relative d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="courses-item d-flex flex-column flex-xl-row arc-shadow overflow-hidden h-100 bg-light rounded-pill shadow-lg">
                        <div class="text-center py-3 px-5 w-100 d-flex align-items-center justify-content-center flex-column">
                            <h5 class="mb-1 mt-2 mt-xl-1 fs-18px">
                                FAA CPL Training in Texas</h5>
                            <p class="fs-12px">
                                Accelerate your path to becoming <br> a pilot with FAA CPL.
                            </p>
                            <a href="./flying/cpltexas.php" class="btn btn-outline-primary btn-sm rounded-pill px-3 py-2 fs-10px">
                                Read more
                            </a>
                            <!-- <ol class="breadcrumb justify-content-center mb-0">
                                <li class="breadcrumb-item small">
        ...
        <div class="card morocco bg-transparent" style="background: none; border:none;">
            <div data-wow-delay="0.1s" class="position-relative d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="courses-item d-flex flex-column flex-xl-row arc-shadow overflow-hidden h-100 bg-light rounded-pill shadow-lg">
                    <div class="text-center py-3 px-5 w-100 d-flex align-items-center justify-content-center flex-column">
                        <h5 class="mb-1 mt-2 mt-xl-1 fs-18px">
                            B737 Type Rating in Morocco</h5>
                        <p class="fs-12px">
                            Demanding program intended to ready <br> individuals for a professional pilot career.
                        </p>
                        <a href="./flying/cplmorocco.php" class="btn btn-outline-primary btn-sm rounded-pill px-3 py-2 fs-10px">
                            Read more
                        </a>
                        <!-- <ol class="breadcrumb justify-content-center mb-0">
                            <li class="breadcrumb-item small">
        ...
        <div class="card tunisia" style="background: none; border:none;">
            <div class="d-flex flex-column gap-2">
                <div data-wow-delay="0.3s" class="position-relative d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="courses-item d-flex flex-column flex-xl-row arc-shadow overflow-hidden h-100 bg-light rounded-pill shadow-lg">
                        <div class="text-center py-3 px-5 w-100 d-flex align-items-center justify-content-center flex-column">
                            ...
                            <p class="fs-12px">Complete both CPL and Type Rating at <br> Tunisia and access student loans for both.</p>
                            <a href="./flying/cpltunisia.php" class="btn btn-outline-primary btn-sm rounded-pill px-3 py-2 fs-10px">
                                Read more
                            </a>
                            ...
                            ">
                                ...
                                <li>
                                    <i class="fa fa-map-marker text-primary me-2"></i>Click to
                                    learn more
                                </li>
                            </ol> -->
                        </div>
                ...
                <div data-wow-delay="0.3s" class="position-relative d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="courses-item d-flex flex-column flex-xl-row arc-shadow overflow-hidden h-100 bg-light rounded-pill shadow-lg">
                        <div class="text-center py-3 px-5 w-100 d-flex align-items-center justify-content-center flex-column">
                            <h5 class="mb-1 mt-2 mt-xl-1 fs-18px">A320 Type Rating</h5>
                            <p class="fs-12px">Complete both CPL and Type Rating at <br> Tunisia and access student loans for both.</p>
                            <a href="./flying/cpltunisia.php" class="btn btn-outline-primary btn-sm rounded-pill px-3 py-2 fs-10px">
                                Read more
                            </a>
                            ...
                            ">
                                ...
                                <li>
                                    <i class="fa fa-map-marker text-primary me-2" style="margin-left: 5px;"></i>Click to
                                    learn more
                                </li>
                            </ol> -->
                        </div>
                ...
                <div class="flag-container tunisia-flag bg-light rounded-pill shadow-lg">
                    <img src="/assets/img/flags/tunisia-flag.jpeg" alt="tunisia">
                    <span>
                        TUNISIA
                    </span>
                </div>
        ...
        <div class=" card australia bg-transparent" style="background: none; border:none;">
            <div data-wow-delay="0.1s" class="position-relative d-flex flex-column align-items-center justify-content-center">
                <a href="/flying/cplaustralia.php">
                    <div class="courses-item d-flex flex-column flex-xl-row overflow-hidden h-100 bg-light rounded-pill shadow-lg">
                        <div class="text-center py-3 px-5 w-100 d-flex align-items-center justify-content-center flex-column">
                            <h5 class="mb-1 mt-2 mt-xl-1 fs-18px">
                                CASA CPL Training In Australia</h5>
                            <p class="fs-12px">
                                Demanding program intended to ready
                                individuals for a professional pilot career
                            </p>
                            <a href="./flying/cplaustralia.php" class="btn btn-outline-primary btn-sm rounded-pill px-3 py-2 fs-10px">
                                Read more
                            </a>
                            <!-- <ol class="breadcrumb justify-content-center mb-0">
                                <li class="breadcrumb-item small">
                ...
                <div class="flag-container australia-flag bg-light rounded-pill shadow-lg">
                    <img src="/assets/img/flags/australia-flag.png" alt="australia">
                    <span>
                        AUSTRALIA
                    </span>
                </div>
            ...
            <div class="demo-class-card mx-auto flex flex-column flex-xl-row border-r8 py-3 py-xl-4 arc-shadow"
                ...
                <div class="demo-class-imgarea d-flex justify-content-center py-4 pt-0 py-xl-0">
                    <div class="d-flex justify-content-center justify-content-xl-start demo-class-imgWrapper">
                        <img loading="lazy" decoding="async" width="799" height="449"
                            src="./img/adynamics-pilot-cource.jpg" class="demo-class-videoImg"
