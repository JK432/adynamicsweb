...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PFNNX2Q3"
    ...
    <div class="map" id="map-container">
        ...
        <svg id="world-map" style="fill: #b9b9b9;" xmlns:dc="http://purl.org/dc/elements/1.1/"
            ...
            <!-- India marker-->
            <circle class="ripple ripple1" cx="670" cy="285" r="30"></circle>
            <circle class="ripple ripple2" cx="670" cy="285" r="15"></circle>
            <circle class="ripple ripple3" cx="670" cy="285" r="4"></circle>
            ...
            <!-- animating lines -->
            <path id="in-sa" class="line" d="M670,285 Q550,300 520,430"></path>
            <path id="sa-usa" class="line" d="M520,430 Q350,400 180,200"></path>
            <path id="ag-in" class="line" d="M280,450 Q350,300 670,285"></path>
            <path id="mor-sa" class="line" d="M420,260 Q450,250 520,430"></path>
            <path id="tun-ag" class="line" d="M480,235 Q300,200 280,450"></path>
            <path id="mor-usa" class="line" d="M420,260 Q350,150 180,200"></path>
            <path id="tun-in" class="line" d="M480,235 Q550,150 670,285"></path>
        ...
        <div class="card tunisia" style="background: none; border:none">
            <div class="d-flex gap-5">
                <div data-wow-delay="0.3s">
                    <div class="courses-item d-flex flex-column arc-shadow overflow-hidden">
                        <div class="text-center p-4">
                            <h5 class="mb-3 mt-2 mt-xl-1">OACA CPL Training in Tunisia</h5>
                            <p>Complete both CPL and Type Rating at Tunisia and access student loans for both.</p>
                ...
                <div data-wow-delay="0.3s">
                    <div class="courses-item d-flex flex-column arc-shadow overflow-hidden">
                        <div class="text-center p-4 ">
                            <h5 class="mb-3 mt-2 mt-xl-1">A320 CPL Training in Tunisia</h5>
                            <p>Complete both CPL and Type Rating at Tunisia and access student loans for both.</p>
                            <ol class="breadcrumb mb-0" style="
                            display:flex;
                            flex-direction:column;
