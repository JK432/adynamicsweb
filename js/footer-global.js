class GlobalFooter extends HTMLElement {
  constructor() {
    ...
    <!-- Call Button -->
  <button
    style="position: fixed; width: 50px; height: 54px; background-color: #FFFFFF !important; border: 1px solid #ddd !important; z-index: 1000 !important; padding: 5px; right: 23px !important; bottom: 150px !important; border: none; color: black; font-size: 28px; border-radius: 100%; display: flex; align-items: center; justify-content: center; line-height: unset;"
    title="Call Now">
    <a href="tel:+91 8050076136" target="_blank" title="Call Now">
      <i class="bi bi-telephone"></i>
    </a>
  </button>

  <button
    style="position: fixed; width: 50px; height: 54px; background-color: #FFFFFF !important; border: 1px solid #ddd !important; z-index: 1000 !important; padding: 5px; right: 23px !important; bottom: 90px !important; border: none; color: black; font-size: 28px; border-radius: 100%; display: flex; align-items: center; justify-content: center; line-height: unset;"
    onclick = "openModal()"
  ...
  <!-- Whatsapp Button -->
  <button
    style="position: fixed; width: 50px; height: 54px; background-color: #FFFFFF !important; border: 1px solid #ddd !important; z-index: 1000 !important; padding: 5px; right: 23px !important; bottom: 30px !important; border: none; color: black; font-size: 28px; border-radius: 100%; display: flex; align-items: center; justify-content: center; line-height: unset;">
